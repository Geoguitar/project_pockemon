...
public class LocalizacaoController {
	...
	public ResponseEntity<Localizacao> updateLocalizacaoById (@PathVariable (value = "id") Long id, 
			...
			log.info("Atualizando por ID os dados de Localização [{}]", id);
	...
	public ResponseEntity<Object> deleteLocalizacaoById (@PathVariable (value = "id") Long id){
		log.info("Apagando dados por ID de Localização [{}]", id);
		return localizacaoService.deleteById(id);
	}
}
